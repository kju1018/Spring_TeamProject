...
<div class="container-fluid">
	...
	<p style="font-size: large;">북유럽식 식탁조명</p><br><br>
	<pre><small style="color: gray">판매가		50,000원<br><br>배송비		2,500원(30,000원 이상 구매 시 무료)<br><br></pre>
    ...
    <table style="width:100%; height:80px; border:1px solid lightgray;">
		<tr>
			<td><small><img src="<%=application.getContextPath()%>/resources/image/icon_sora.gif"><b>수량을 선택해주세요.</b>
                ...
                <small style="margin-left:27%;">50,000원</small></td>
