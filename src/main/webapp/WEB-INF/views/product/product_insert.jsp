...
<%@ include file="/WEB-INF/views/common/header.jsp" %>
    ...
    <div class="container-xl" style="margin-top: 18em;" >
        <form id="insert" name="insert" action="<%=application.getContextPath()%>/product/insert" method="post" >
            <div class="col" style=" text-align: center;"><h3>상품 추가</h3></div>
            ...
            <!-- <%=application.getContextPath()%>/auth/signup_complete -->
            	<button type="submit" class="btn btn-lg btn-dark">상품 추가</button>  
            </div>
        </form>
    </div>
